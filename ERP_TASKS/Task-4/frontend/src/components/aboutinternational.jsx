...
export default function About() {
    ...
    useEffect(() => {
        const getdata = async () => {
            const response = await fetch(`${serverurl}/api/addirform`, {
                method: "GET",
                headers: {
        ...
        <div className="container my-5">
            ...
            >
                <ul className="list-group">
                    ...
                    <li className="list-group-item">
                        <strong>Student Phone:</strong> {formData.studentPhone}
                    </li>
                    <li className="list-group-item">
                        <strong>Father Name:</strong> {formData.fatherName}
                    </li>
                    <li className="list-group-item">
                        <strong>Father Phone:</strong> {formData.fatherPhone}
                    </li>
                    <li className="list-group-item">
                        <strong>Mother Name:</strong> {formData.motherName}
                    </li>
                    <li className="list-group-item">
                        <strong>Mother Phone:</strong> {formData.motherPhone}
                    </li>
                    <li className="list-group-item">
                    ...
                    <li className="list-group-item">
                        <strong>Visa Number:</strong> {formData.visaNumber}
                    </li>
                    <li className="list-group-item">
                    ...
                    <li className="list-group-item">
                        ...
                        {formData.visaIssuedCountry}
                    </li>
                    <li className="list-group-item">
                        <strong>Visa Issued Place:</strong>{" "}
                        {formData.visaIssuedPlace}
                    </li>
                </ul>
            </div>
        </div>
