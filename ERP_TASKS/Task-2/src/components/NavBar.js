...
import logo from "../assets/LOGO_change.jpg";
        ...
        <>
            ...
            >
                <div className="py-2 w-50 position-relative mx-auto">
                    <p className="ps-4">
                        విజ్ఞాన శాస్త్ర సాంకేతిక పరిశోధనా సంస్థ / विज्ञान
                        शास्त्र प्रौद्योगिकी और परिशोधन संगठन
                    </p>
                </div>
                <div
                    className="py-2 w-50 ms-auto position-relative mx-auto"
                    style={{
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav ms-auto">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul
                                    className="dropdown-menu"
                                    aria-labelledby="peopleDropdown"
                                >
                                    <li>
                                        <a className="dropdown-item" href="#">
                                            Faculty
